...
export default Hero;
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Button size="lg" className="btn-primary-glow text-base px-8 py-6 rounded-xl font-semibold" onClick={() => scrollToSection('contact')}>Contact Me</Button>
              <Button variant="outline" size="lg" className="text-base px-8 py-6 rounded-xl font-semibold border-2 border-primary/40 hover:border-primary transition-all duration-300" onClick={() => scrollToSection('experience')}>View Experience</Button>
              <Button variant="outline" size="lg" asChild className="text-base px-8 py-6 rounded-xl font-semibold border-2 border-accent/40 hover:border-accent transition-all duration-300 group">
                <a href="/portfolio/Aditya_Lolla_Resume.pdf" download="Aditya_Srivatsav_Lolla_Resume.pdf">
                  <Download className="mr-2 h-5 w-5 group-hover:animate-bounce" />
                  Download Resume
                </a>
